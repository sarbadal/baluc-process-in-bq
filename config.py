...
def load_config() -> ConfigMap:
    ...
    identifier_values = [
        ...
        os.getenv("EV_CITY_COLUMN", "city").strip(),
        ...
        os.getenv("CONTRACT_CITY_COLUMN", "city").strip(),
    ...
    return {
        ...
        "ev_city_column": os.getenv("EV_CITY_COLUMN", "city").strip(),
        ...
        "contract_city_column": os.getenv("CONTRACT_CITY_COLUMN", "city").strip(),
